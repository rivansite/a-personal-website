...
export default function Header() {
  return (
    <section className="w-full h-screen pt-[40%] md:pt-[12%] px-[15%] flex gap-5 2xl:justify-center flex-col md:flex-rwo">
      <div className="md:w-[600px] w-full">
        <Image src={Lyn} />
      </div>
      <div className="md:w-[300px] flex flex-col gap-3 2xl:w-[400px]">
